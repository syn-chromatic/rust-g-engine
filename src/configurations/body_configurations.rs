...
pub fn get_grid_cuboid() -> BodyType {
    let mut cuboid = Cuboid::new(1_000_000.0, 1_000_000.0, 1_000_000.0);
    let position = (-1_000_000.0, -5_000_000.0, -1_000_000.0);
    cuboid.set_offset(position.0, position.1, position.2);
...
pub fn get_obj(file_path: &str, decomp_tolerance: f64) -> BodyType {
    ...
    let mut mesh = obj.get_polygons();
    mesh.set_uniform_color(RGBA::from_rgb(1.0, 0.4, 0.4));
...
pub fn get_sphere_light_highmass() -> BodyType {
    let position: Vector3D = Vector3D::new(50_000.0, -100.0, 50_000.0);
    ...
    let mut sphere = Sphere::new(500_000.0, 10, 10);
